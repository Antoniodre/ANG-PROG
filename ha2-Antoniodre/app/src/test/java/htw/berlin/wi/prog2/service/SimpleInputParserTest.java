...
class SimpleInputParserTest {
    ...
    void ingredientsFromInput() {
        ...
        // Test-Daten
        String input = "Ich hätte gerne eine Italian-style Pizza mit Schinken, Kirschtomaten und Tomatensauce.";
        Ingredient duennerTeig = Menu.base.get(2);
        Ingredient schinken = Menu.protein.get(3);
        Ingredient tomate = Menu.topping.get(5);
        Ingredient sauce = Menu.sauces.get(9);

        List<Ingredient> expected = List.of(duennerTeig, schinken, tomate, sauce);
